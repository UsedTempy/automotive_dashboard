...
class FanSliderThumb extends StatefulWidget {
  ...
  const FanSliderThumb({super.key, required this.value, required this.onChanged});

  @override
  State<FanSliderThumb> createState() => _FanSliderThumbState();
}

class _FanSliderThumbState extends State<FanSliderThumb>
  ...
  void _onPress() => _scaleController.forward(from: 0);
  void _onRelease() => _scaleController.reverse(from: 1.0);
